import { PdoI, PdoRawConnectionI } from '../../src';
...
import PdoTransactionPreparedStatement from '../../src/support/pdo-transaction-prepared-statement';
...
describe('Pdo Transactions', () => {
  ...
  it('Works Transaction Error On Begin Transaction', async () => {
    ...
    await expect(pdoStub.beginTransaction()).rejects.toThrow(
